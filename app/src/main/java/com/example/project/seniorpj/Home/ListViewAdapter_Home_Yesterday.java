...
public class ListViewAdapter_Home_Yesterday extends BaseAdapter implements Filterable {
    ...
    public ListViewAdapter_Home_Yesterday(List<String> foodName) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = mInflater.inflate(R.layout.item_listview_home_yesterday, parent, false);

        tvNameFood = (TextView) convertView.findViewById(R.id.tv_namefood_yesterday);
        tvEnergy = (TextView) convertView.findViewById(R.id.tv_energy_yesterday);
